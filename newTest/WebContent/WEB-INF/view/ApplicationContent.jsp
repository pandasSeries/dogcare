...
<c:import url="Menu.jsp"></c:import>
 ...
 <div class="main" style="background-color: white; display: flex; justify-content: space-between;">
	...
	<div class="right" style="width: 60%; display: flex; justify-content: space-around;">
		...
		<div style="width: 70%; display: flex; justify-content: space-around; box-shadow: 0px 0px 5px rgba(0, 0, 0, 0.2); margin-top: 25px; margin-bottom: 25px; align-items: center;">
			...
			<div style="width: 20%; text-align: center; background-color: #F2F2F2;">
				...
				<c:forEach var="dog" items="${dogList }" varStatus="status">
					<c:set var="dog2" value="${petsittingSearch[status.index]}" />
					<br>
					<img style="border: solid white 1px; width: 90%; height: 60%; object-fit: cover; border-radius: 50%" id="dogImage" src="images/${dog2.PIC_PATH }" alt="Dog Photo">
			...
			<div style="width: 70%; line-height: 70%;">
				...
				<c:forEach var="petsitter" items="${petsitterList }">
					<div style="display: flex; justify-content: space-around; width:80%; background-color: #F2F2F2; align-items: center;">
						<div style="width: 5%;"></div>
		...
		<div style="width: 15%;">
			<br><br>
			<button type="button" style="border: none; background-color: #F2F2F2; border-radius: 8px; width: 100px; font-weight: 600; margin-bottom: 5px;"><br>지원하기<br><br></button> 
			<button type="button" style="border: none; background-color: #F2F2F2; border-radius: 8px; width: 100px; font-weight: 600; margin-bottom: 5px;"><br>선택하기<br><br></button>
			<button type="button" style="border: none; background-color: #F2F2F2; border-radius: 8px; width: 100px; font-weight: 600; margin-bottom: 5px;"><br>삭제하기<br><br></button> 
		</div>
	</div>
	<div style="width: 10%;"></div>
</div>
