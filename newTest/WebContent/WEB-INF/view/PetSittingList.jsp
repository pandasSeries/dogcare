	...
	<div class="right" style="width: 60%; display: flex; justify-content: space-around;">
		...
		<div style="width:95%;">
			...
			<c:forEach var="req" items="${list }" varStatus="status">
				<c:set var="req2" value="${petsittingList[status.index]}" />
				<div data-postCd="${req.post_cd }" onclick="movePage(this)" style="width: 32%; display: flex; justify-content: space-around; background-color: #F2F2F2; border-radius: 10px; text-align: center;">
					...
					<div style="width: 30%;">
						<br>
							<%-- <c:forEach var="map" items="${petsittingSearch}" >
								<img style="border: solid white 1px; width: 100%; height: 70%; object-fit: cover; border-radius: 50%" id="dogImage" src="images/${map.PIC_PATH }" alt="Dog Photo">
							</c:forEach> --%>
							<img style="border: solid white 1px; width: 100%; height: 70%; object-fit: cover; border-radius: 50%" id="dogImage" src="images/${req2.PIC_PATH }" alt="Dog Photo">
